Drupal.behaviors.selfservice = function() {
	...
	if (typeof $('#selfservice-category-form-fieldset .form-file').attr('id') != 'undefined') {
		$('#selfservice-category-form-fieldset .form-file').attr('name', $('#selfservice-category-form-fieldset .form-file').attr('id').replace('edit-new-', 'new_')+'[]');
	}
	
	$("[id$=-extranote-wrapper]").hide();
		
	$('#selfservice-category-form-fieldset .form-select').change(function() {
	...
	$('#selfservice-category-form-fieldset .form-checkbox').click(function() {
	    var id = '#edit-'+ $(this).attr('name').replace('_', '-') + '-extranote-wrapper';
		id = id.replace('['+$(this).val()+']', '');		
				
		var n = $('#selfservice-category-form-fieldset .form-checkbox:checked').length;
		if(n){
			$('#selfservice-category-form-fieldset .form-checkbox:checked').each(function(index) {	
	...
	$('#selfservice-category-form-fieldset .form-radio').click(function() {
		var option_text = $.trim($(this).parent().text()).toLowerCase();			
		var id = '#edit-'+ $(this).attr('name').replace('_', '-') + '-extranote-wrapper';	
	...
	$('#selfservice-category-form-fieldset').find('label').each(function(index) {			
